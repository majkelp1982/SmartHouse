...
public class ExtLightsView extends View {
  ...
  private VerticalLayout createLightView(final int id) {
    ...
    final Info info =
        new Info(
            ...
            false,
            false,
            module_extLights.getLightDimmer()[id].getIntens(),
            0,
            0,
            0);
    ...
    setIntens
        ...
        .addValueChangeListener(
            valueChangeEvent -> {
              module_extLights.getNVLightDimmer()[id].setStandByIntens(
    ...
    maxIntens
        ...
        .addValueChangeListener(
            valueChangeEvent -> {
              module_extLights.getNVLightDimmer()[id].setMaxIntens(
                  (int) Math.round(valueChangeEvent.getValue()));
  ...
  private void createInfoSection1() {
    ...
    setOffTimeMinute
        ...
        .addValueChangeListener(
            valueChangeEvent -> {
              module_extLights.setNVoffTime(
                  LocalTime.of(
                      module_extLights.getOffTime().getHour(),
                      (int) Math.round(valueChangeEvent.getValue())));
    ...
    layout.add(
        setStartIntensLevel.getSource(), setOffTimeHour.getSource(), setOffTimeMinute.getSource());
  ...
  void update() {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      maxIntens.setNumberField(
          module_extLights.getLightDimmer()[i].getMaxIntens(),
