...
public class ComfortView extends View {
  ...
  private void createInfoSection0() {
    ...
    // Salon
    info[0][0][0] =
        new Info("temperatura", "°C", true, false, zone[0].isTemp, zone[0].reqTemp, 0.5, 1);
    ...
    // Pralnia
    info[0][1][0] =
        new Info("temperatura", "°C", true, false, zone[1].isTemp, zone[1].reqTemp, 0.5, 1);
    ...
    // laz.dol
    info[0][2][0] =
        new Info("temperatura", "°C", true, false, zone[2].isTemp, zone[2].reqTemp, 0.5, 1);
  ...
  private void createInfoSection1() {
    ...
    // rodzice
    info[1][0][0] =
        new Info("temperatura", "°C", true, false, zone[3].isTemp, zone[3].reqTemp, 0.5, 1);
    ...
    // Natalia
    info[1][1][0] =
        new Info("temperatura", "°C", true, false, zone[4].isTemp, zone[4].reqTemp, 0.5, 1);
    ...
    // Karolina
    info[1][2][0] =
        new Info("temperatura", "°C", true, false, zone[5].isTemp, zone[5].reqTemp, 0.5, 1);
    ...
    // laz.gora
    info[1][3][0] =
        new Info("temperatura", "°C", true, false, zone[6].isTemp, zone[6].reqTemp, 0.5, 1);
